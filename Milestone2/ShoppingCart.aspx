<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="Milestone2.ShoppingCart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <asp:GridView ID="CartList" runat="server" AutoGenerateColumns="False"
      ...
      ItemType="Milestone2.Models.CartItem"
      ...
      <Columns>
         ...
         <asp:BoundField DataField="Product.UnitPrice" HeaderText="Price (per day)"
            DataFormatString="{0:c}"/>
         <asp:TemplateField HeaderText="Number of Days">
            <ItemTemplate>
               <asp:TextBox ID="PurchaseNumberOfDays" Width="40"
                  runat="server" Text="<%#: Item.Quantity %>"></asp:TextBox>
            </ItemTemplate>
         </asp:TemplateField>
         <asp:TemplateField HeaderText="Vehicle Rental Cost">
            <ItemTemplate>
               <%#: String.Format("{0:c}",
