...
namespace Milestone2.Logic
{
    public class ShoppingCartActions : IDisposable
    {
        ...
        CartItemUpdates)
        {
            using (var db = new Milestone2.Models.ProductContext())
            {
                try
                {
                    ...
                    {
                        // Move through the rows in shopping list
        ...
        {
            using (var _db = new Milestone2.Models.ProductContext())
            {
                try
                {
